...
if (isset($_POST['graduatebox'])) {$graduatebox = '1';}
else {$graduatebox = '0';}
if (isset($_POST['undergraduatebox'])) {$undergraduatebox = '1';}
else {$undergraduatebox = '0';}
if (isset($_POST['highschoolbox'])) {$highschoolbox = '1';}
else {$highschoolbox = '0';}
